...
#
#     from lowbot import metadata
#
# However, when we do this, we also import `lowbot/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'lowbot_cli = lowbot.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'lowbot_gui = lowbot.gui:entry_point'
        # ]
    }
)
